...
// Retrieve booking and user information
$sql = "SELECT b.*, u.first_name, u.last_name, r.room_type, r.room_price FROM bookings b 
...
// Insert invoice into database if it doesn't already exist and retrieve the invoice id
...
$stmt->bind_param("isssi", $booking_id, $booking['total_amount'], $booking['payment_status'], $booking['email'], $booking_id);
$stmt->execute();
...
// Update the invoice_id in the invoices table
...
$total_amount = $room_total + $extra_bed_total + $breakfast_total;
?>
            ...
            <div class="invoice-container">
                    ...
                    <div class="invoice-body">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Extra Bed</td>
                                    <td>RM 10</td>
                                    <td><?php echo $extra_bed_qty; ?></td>
                                    <td class="text-end">RM <?php echo number_format($extra_bed_total, 2); ?></td>
                                </tr>
                                <tr>
                                    <td>Breakfast Charge</td>
                                    <td>Breakfast</td>
                                    <td>RM 35</td>
                                    <td><?php echo $breakfast_qty; ?></td>
                                    <td class="text-end">RM <?php echo number_format($breakfast_total, 2); ?></td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="invoice-body-bottom">
                            <div class="invoice-body-info-item border-bottom">
                                ...
                                <div class="info-item-td text-end">RM <?php echo number_format($total_amount, 2); ?></div>
                            </div>
                            <div class="invoice-body-info-item border-bottom">
                                <div class="info-item-td text-end text-bold">Tax:</div>
                                <div class="info-item-td text-end">RM 0.00</div>
                            </div>
                ...
                <div class="invoice-foot text-center">
                    ...
                    <div class="invoice-btns">
                        ...
                        <a href="index.php"><button type="button" class="invoice-btn">
                            <span>
        ...
        function generatePDF() {
            var docDefinition = {
                content: [
                    ...
                    '\n\n',
                    {
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                [ 'Extra Bed Charge', 'Extra Bed', 'RM 10', '<?php echo $extra_bed_qty; ?>', 'RM <?php echo number_format($extra_bed_total, 2); ?>' ],
                                [ 'Breakfast Charge', 'Breakfast', 'RM 35', '<?php echo $breakfast_qty; ?>', 'RM <?php echo number_format($breakfast_total, 2); ?>' ]
                            ]
                        }
                    },
                    '\n\n',
                    {
                        columns: [
                            ...
                            },
                            {
                                ...
                                table: {
                                    body: [
                                        [ { text: 'Sub Total:', style: 'subheader', alignment: 'right' }, 'RM <?php echo number_format($total_amount, 2); ?>' ],
                                        [ { text: 'Tax:', style: 'subheader', alignment: 'right' }, 'RM 0.00' ],
                                        [ { text: 'Total:', style: 'subheader', alignment: 'right' }, 'RM <?php echo number_format($total_amount, 2); ?>' ]
                                    ]
                                },
                                layout: 'noBorders'
                            }
                    ...
                    '\n\n',
                    { text: 'NOTE: This is computer generated receipt and does not require physical signature.', style: 'note' }
                ],
                styles: {
                    header: {
                        fontSize: 18,
